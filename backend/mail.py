...
SENDER_ADDRESS = "quiz-master@donotreply.in"
SENDER_PASSWORD = ""
...
def send_email_template(to_address, subject, template_file, context, content = "html", attachment_file = None):
    with open(template_file, 'r') as file:
        template = Template(file.read())
        message = template.render(context)
        return send_email(to_address, subject, message, content, attachment_file)